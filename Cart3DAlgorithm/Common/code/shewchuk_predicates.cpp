...
#define Two_Square(a1, a0, x5, x4, x3, x2, x1, x0) \
	...
	namespace shewchuk {
		...
		/*****************************************************************************/
		/*                                                                           */
		/*  cfloatprint()   Print the bit representation of a cfloat.                */
		/*                                                                           */
		...
		*/
		...
		/*****************************************************************************/
		/*                                                                           */
		/*  cfloatrand()   Generate a cfloat with random 53-bit significand and a    */
		...
		cfloat cfloatrand()
		{
		  ...
		  b = random();
		  c = random();
		  result = (cfloat) (a - 1073741824) * 8388608.0 + (cfloat) (b >> 8);
		...
		*/
		...
		/*****************************************************************************/
		/*                                                                           */
		/*  narrowcfloatrand()   Generate a cfloat with random 53-bit significand    */
		/*                       and a random exponent in [0, 7].                    */
		/*                                                                           */
		/*****************************************************************************/

		/*
		cfloat narrowcfloatrand()
		{
		  cfloat result;
		  cfloat expo;
		  long a, b, c;
		...
		*/
		...
		/*****************************************************************************/
		/*                                                                           */
		/*  uniformcfloatrand()   Generate a cfloat with random 53-bit significand.  */
		/*                                                                           */
		/*****************************************************************************/

		/*
		cfloat uniformcfloatrand()
		{
		  cfloat result;
		  long a, b;
...
#	endif				/* not SINGLE */
		...
		int grow_expansion(int elen, const cfloat* e, cfloat b, cfloat* h)
		...
		int grow_expansion_zeroelim(int elen, const cfloat* e, cfloat b, cfloat* h)
			/* e and h can be the same. */
		{
			cfloat Q, hh;
			INEXACT cfloat Qnew;
		...
		int expansion_sum(int elen, const cfloat* e, int flen, const cfloat* f, cfloat* h)
		...
		int expansion_sum_zeroelim1(int elen, const cfloat* e, int flen, const cfloat* f, cfloat* h)
			/* e and h can be the same, but f and h cannot. */
		{
			cfloat Q;
			INEXACT cfloat Qnew;
		...
		int expansion_sum_zeroelim2(int elen, const cfloat* e, int flen, const cfloat* f, cfloat* h)
			/* e and h can be the same, but f and h cannot. */
		{
			cfloat Q, hh;
			INEXACT cfloat Qnew;
		...
		int fast_expansion_sum(int elen, const cfloat* e, int flen, const cfloat* f, cfloat* h)
			/* h cannot be e or f. */
		{
			cfloat Q;
			INEXACT cfloat Qnew;
		...
		int fast_expansion_sum_zeroelim(int elen, const cfloat* e, int flen, const cfloat* f, cfloat* h)
			/* h cannot be e or f. */
		{
			cfloat Q;
			INEXACT cfloat Qnew;
		...
		int linear_expansion_sum(int elen, const cfloat* e, int flen, const cfloat* f, cfloat* h)
			/* h cannot be e or f. */
		{
			cfloat Q, q;
			INEXACT cfloat Qnew;
		...
		int linear_expansion_sum_zeroelim(int elen, const cfloat* e, int flen, const cfloat* f,
			cfloat* h)
			/* h cannot be e or f. */
		{
			cfloat Q, q, hh;
		...
		int scale_expansion(int elen, const cfloat* e, cfloat b, cfloat* h)
		...
		int scale_expansion_zeroelim(int elen, const cfloat* e, cfloat b, cfloat* h)
			/* e and h cannot be the same. */
		{
		...
		int compress(int elen, const cfloat* e, cfloat* h)
		...
		cfloat estimate(int elen, const cfloat* e)
		{
			cfloat Q;
			int eindex;
		...
		cfloat orient2dfast(const cfloat* pa, const cfloat* pb, const cfloat* pc)
		{
		...
		cfloat orient2dexact(const cfloat* pa, const cfloat* pb, const cfloat* pc)
		{
		...
		cfloat orient2dslow(const cfloat* pa, const cfloat* pb, const cfloat* pc)
		{
		...
		cfloat orient2dadapt(const cfloat* pa, const cfloat* pb, const cfloat* pc, cfloat detsum)
		{
			INEXACT cfloat acx, acy, bcx, bcy;
		...
		cfloat orient2d(const cfloat* pa, const cfloat* pb, const cfloat* pc)
		{
		...
		cfloat orient3dfast(const cfloat* pa, const cfloat* pb, const cfloat* pc, const cfloat* pd)
		{
			cfloat adx, bdx, cdx;
			cfloat ady, bdy, cdy;
			cfloat adz, bdz, cdz;
		...
		cfloat orient3dexact(const cfloat* pa, const cfloat* pb, const cfloat* pc, const cfloat* pd)
		{
		...
		cfloat orient3dslow(const cfloat* pa, const cfloat* pb, const cfloat* pc, const cfloat* pd)
		{
		...
		cfloat orient3dadapt(const cfloat* pa, const cfloat* pb, const cfloat* pc, const cfloat* pd, const cfloat permanent)
		{
		...
		cfloat orient3d(const cfloat* pa, const cfloat* pb, const cfloat* pc, const cfloat* pd)
		{
		...
		cfloat incirclefast(const cfloat* pa, const cfloat* pb, const cfloat* pc, const cfloat* pd)
		{
		...
		cfloat incircleexact(const cfloat* pa, const cfloat* pb, const cfloat* pc, const cfloat* pd)
		{
			INEXACT cfloat axby1, bxcy1, cxdy1, dxay1, axcy1, bxdy1;
			INEXACT cfloat bxay1, cxby1, dxcy1, axdy1, cxay1, dxby1;
			cfloat axby0, bxcy0, cxdy0, dxay0, axcy0, bxdy0;
		...
		cfloat incircleslow(const cfloat* pa, const cfloat* pb, const cfloat* pc, const cfloat* pd)
		{
		...
		cfloat incircleadapt(const cfloat* pa, const cfloat* pb, const cfloat* pc, const cfloat* pd, cfloat permanent)
		{
			INEXACT cfloat adx, bdx, cdx, ady, bdy, cdy;
			cfloat det, errbound;
		...
		cfloat incircle(const cfloat* pa, const cfloat* pb, const cfloat* pc, const cfloat* pd)
		{
		...
		cfloat inspherefast(const cfloat* pa, const cfloat* pb, const cfloat* pc, const cfloat* pd, const cfloat* pe)
		{
		...
		cfloat insphereexact(const cfloat* pa, const cfloat* pb, const cfloat* pc, const cfloat* pd, const cfloat* pe)
		{
		...
		cfloat insphereslow(const cfloat* pa, const cfloat* pb, const cfloat* pc, const cfloat* pd, const cfloat* pe)
		{
		...
		cfloat insphereadapt(const cfloat* pa, const cfloat* pb, const cfloat* pc, const cfloat* pd, const cfloat* pe,
			cfloat permanent)
		{
			INEXACT cfloat aex, bex, cex, dex, aey, bey, cey, dey, aez, bez, cez, dez;
			cfloat det, errbound;
		...
		cfloat insphere(const cfloat* pa, const cfloat* pb, const cfloat* pc, const cfloat* pd, const cfloat* pe)
		{
			cfloat aex, bex, cex, dex;
			cfloat aey, bey, cey, dey;
			cfloat aez, bez, cez, dez;
