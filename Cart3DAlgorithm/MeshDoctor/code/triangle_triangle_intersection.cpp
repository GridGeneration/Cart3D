...
#include <cstdlib>
#include <iostream>
#include "MeshDoctor/triangle_triangle_intersection.h"
#include <Common/shewchuk_predicates.h>
#include "triangle_triangle_intersection_core/Wm4Intersector.h"
#include <assert.h>
namespace Cart3DAlgorithm
{
	...
	//	inline cfloat orient3d_exact(
	//		const cvector3d& a,
	//		const cvector3d& b,
	//		const cvector3d& c,
	//		const cvector3d& d)
	//	{
	//		return shewchuk::orient3d(a.data(), b.data(), c.data(), d.data());
	//	}

	//	inline cfloat orient2d_exact(const cvector2d& a, const cvector2d& b, const cvector2d& c)
	//	{
	//		return shewchuk::orient2d(a.data(), b.data(), c.data());
	//	}

	//	cvector3d normal(const cvector3d tri[3])
	//	{
	//		return (tri[1] - tri[0]).cross(tri[2] - tri[0]);
	//	}

	//	void extent(cfloat a, cfloat b, cfloat c, cfloat& lo, cfloat& hi)
	//	{
	...
	//	bool axis_test(const cvector3d tri_a[3], const cvector3d tri_b[3])
	//	{
	//		cfloat a_lo, a_hi, b_lo, b_hi;
	//		extent(tri_a[0][dim], tri_a[1][dim], tri_a[2][dim], a_lo, a_hi);
	//		extent(tri_b[0][dim], tri_b[1][dim], tri_b[2][dim], b_lo, b_hi);
	//		return a_hi < b_lo || b_hi < a_lo;
	//	}

	//	// returns true if no intersection, based upon axis testing.
	//	bool sat_bbox(const cvector3d tri_a[3], const cvector3d tri_b[3])
	//	{
	...
	//	sat_t sat_normal(const cvector3d tri_a[3], const cvector3d tri_b[3])
	//	{
	//		cfloat v, lo, hi;
	...
	//	bool sat_plane(const cvector3d tri_a[3], const cvector3d tri_b[3], unsigned i, unsigned j,
	//		unsigned k)
	//	{
	//		cfloat a;
	//		cfloat b;
	...
	//	//           0 - touching
	//	//          +1 - intersection
	//	int sat_edge(const cvector2d tri_a[3], const cvector2d tri_b[3], unsigned i)
	//	{
	...
	//	//           0 - touching
	//	//          +1 - intersection
	//	int sat_edge(const cvector2d tri_a[3], const cvector2d tri_b[3], unsigned i, unsigned j)
	//	{
	...
	//	int test_sharing(
	//		const cvector<ndim> tri_a[3],
	//		const cvector<ndim> tri_b[3], size_t& ia,
	//		size_t& ib)
	//	{
	//		size_t a, b;
	...
	//	template<unsigned ndim>
	//	int largestAxis(const cvector<ndim>& a)
	//	{
	//		int idx = 0;
	//		double hi = fabs(a[0]);
	...
	//	void find_projection_axes(const cvector3d tri[3], unsigned& a1, unsigned& a2)
	//	{
	//		unsigned a0 = largestAxis<3>(normal(tri));
	//		a1 = (a0 + 1) % 3;
	//		a2 = (a0 + 2) % 3;
	//	}

	//	template<unsigned ndim>
	//	cvector<2> select(const cvector<ndim>& a, int a1, int a2)
	//	{
	//		cvector<2> r;
	//		r[0] = a[a1];
	//		r[1] = a[a2];
	...
	//	template<unsigned ndim>
	//	cvector<3> select(const cvector<ndim>& a, int a1, int a2, int a3)
	//	{
	//		cvector<3> r;
	//		r[0] = a[a1];
	//		r[1] = a[a2];
	...
	//	bool isAnticlockwise(const cvector2d tri[3])
	//	{
	//		return shewchuk::orient2d(tri[0].data(), tri[1].data(), tri[2].data()) > 0.0;
	//	}


	//	void project_triangles(
	//		const cvector3d tri_a[3], const cvector3d tri_b[3], 
	//		cvector2d ptri_a[3], cvector2d ptri_b[3])
	//	{
	//		unsigned a1, a2;
	//		find_projection_axes(tri_a, a1, a2);

	//		ptri_a[0] = select<2>(tri_a[0], a1, a2);
	//		ptri_a[1] = select<2>(tri_a[1], a1, a2);
	//		ptri_a[2] = select<2>(tri_a[2], a1, a2);

	//		if (!isAnticlockwise(ptri_a))
	//		{
	//			std::swap(ptri_a[0], ptri_a[2]);
	//		}

	//		ptri_b[0] = select<2>(tri_b[0], a1, a2);
	//		ptri_b[1] = select<2>(tri_b[1], a1, a2);
	//		ptri_b[2] = select<2>(tri_b[2], a1, a2);

	//		if (!isAnticlockwise(ptri_b))
	//		{
	//			std::swap(ptri_b[0], ptri_b[2]);
	//		}
	//	}

	//	TriangleInt triangle_intersection_coplanar(
	//		const cvector3d tri_a[3],
	//		const cvector3d tri_b[3])
	//	{
	//		cvector2d ptri_a[3], ptri_b[3];
	//		project_triangles(tri_a, tri_b, ptri_a, ptri_b);
	//		return TriTriIntersectionTools::triangle_intersection(ptri_a, ptri_b);
	//	}

	//	bool triangle_intersection_coplanar_simple(
	//		const cvector3d tri_a[3],
	//		const cvector3d tri_b[3])
	//	{
	//		cvector2d ptri_a[3], ptri_b[3];
	//		project_triangles(tri_a, tri_b, ptri_a, ptri_b);
	//		return TriTriIntersectionTools::triangle_intersection_simple(ptri_a, ptri_b);
	//	}

	//	TriangleIntType triangle_intersection_coplanar_exact(
	//		const cvector3d tri_a[3], const cvector3d tri_b[3])
	//	{
	//		cvector2d ptri_a[3], ptri_b[3];
	//		project_triangles(tri_a, tri_b, ptri_a, ptri_b);
	//		return TriTriIntersectionTools::triangle_intersection_exact(ptri_a, ptri_b);
	//	}
	...
	//	void normal_sign(const cvector3d tri_a[3], const cvector3d tri_b[3], int nb[3])
	//	{
	...
	//	int line_segment_tri_test(const cvector3d tri_a[3], const cvector3d& a, const cvector3d& b)
	//	{
	//		int o[3];
	//		int c[3];
	...
	//	bool touches_edge(const cvector3d tri_a[3], const int nb[3], const cvector3d tri_b[3])
	//	{
	//		unsigned i = 0;
	//		if (nb[1] != 0)
	//		{
	...
	//		pline_b[0] = select<2>(tri_b[(i + 1) % 3], a1, a2);
	//		pline_b[1] = select<2>(tri_b[(i + 2) % 3], a1, a2);

	//		return TriTriIntersectionTools::triangle_linesegment_intersection_exact(ptri_a, pline_b) !=TR_TYPE_NONE;
	//	}

	//	bool touches_vert(const cvector3d tri_a[3], const int nb[3], const cvector3d tri_b[3])
	//	{
	//		unsigned i = 0;
	//		if (nb[1] == 0)
	//		{
	...
	//		ppt_b = select<2>(tri_b[i], a1, a2);

	//		return TriTriIntersectionTools::triangle_point_intersection_exact(ptri_a, ppt_b) !=TR_TYPE_NONE;
	//	}

	//	unsigned half_test(const cvector3d tri_a[3], const int nb[3], const cvector3d tri_b[3])
	//	{
	//		unsigned c = 0;
	...
	//TriangleInt TriTriIntersectionTools::triangle_intersection(const cvector2d tri_a[3], const cvector2d tri_b[3])
	//{
	//	// triangles must be anticlockwise, or colinear.
	//	assert(orient2d(tri_a[0].data(), tri_a[1].data(), tri_a[2].data()) >= 0.0);
	//	assert(orient2d(tri_b[0].data(), tri_b[1].data(), tri_b[2].data()) >= 0.0);
	...
	//TriangleInt TriTriIntersectionTools::triangle_intersection(const cvector3d tri_a[3], const cvector3d tri_b[3])
	//{
	...
	//bool TriTriIntersectionTools::triangle_intersection_simple(const cvector2d tri_a[3], const cvector2d tri_b[3])
	//{
	//	// triangles must be anticlockwise, or colinear.
	//	assert(orient2d_exact(tri_a[0].data(), tri_a[1].data(), tri_a[2].data()) >= 0.0);
	//	assert(orient2d_exact(tri_b[0].data(), tri_b[1].data(), tri_b[2].data()) >= 0.0);
	...
	//bool TriTriIntersectionTools::triangle_intersection_simple(const cvector3d tri_a[3], const cvector3d tri_b[3])
	//{
	//	if (sat_bbox(tri_a, tri_b))
	//	{
	//		return false;
	...
	//TriangleIntType TriTriIntersectionTools::triangle_point_intersection_exact(const cvector2d tri_a[3],
	...
	//TriangleIntType TriTriIntersectionTools::triangle_linesegment_intersection_exact(const cvector2d tri_a[3],
	...
	//TriangleIntType TriTriIntersectionTools::triangle_intersection_exact(const cvector2d tri_a[3],
	...
	//		return TR_TYPE_INT;
	//	default:
	//		return TR_TYPE_OTHER;
	//	}
	//}

	//TriangleIntType TriTriIntersectionTools::triangle_intersection_exact(const cvector3d tri_a[3],
	//	const cvector3d tri_b[3])
	//{
	...
	int TriTriIntersectionTools::triangle_intersection_exact(
	...
	{
		auto Round = [](cfloat a) {
			return std::round(a * 1e4 + 0.5) * 1e-4;
		};

		Vector3<cfloat> P1(Round(a1[0]), Round(a1[2]), Round(a1[3]));
		Vector3<cfloat> P2(Round(a2[0]), Round(a2[2]), Round(a2[3]));
		Vector3<cfloat> P3(Round(a3[0]), Round(a3[2]), Round(a3[3]));

		Vector3<cfloat> Q1(Round(b1[0]), Round(b1[2]), Round(b1[3]));
		Vector3<cfloat> Q2(Round(b2[0]), Round(b2[2]), Round(b2[3]));
		Vector3<cfloat> Q3(Round(b3[0]), Round(b3[2]), Round(b3[3]));

		Triangle3<cfloat> tri0(P1, P2, P3);
		Triangle3<cfloat> tri1(Q1, Q2, Q3);
		IntrTriangle3Triangle3<cfloat> int_tools(tri0, tri1);
		lines.clear();
		if (int_tools.Find())
		{
			int npts = int_tools.GetQuantity();
			lines.resize(npts);
			for (int i = 0; i < npts; ++i)
			{
				const auto& p = int_tools.GetPoint(i);
				lines[i][0] = static_cast<cfloat>(Round(p[0]));
				lines[i][1] = static_cast<cfloat>(Round(p[1]));
				lines[i][2] = static_cast<cfloat>(Round(p[2]));
			}
		}
