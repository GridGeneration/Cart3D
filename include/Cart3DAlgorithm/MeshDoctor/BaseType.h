...
namespace Cart3DAlgorithm
{
	...
	MESHDOCTOR_API cfloat __stdcall DistancePointToTriangle(const cvector2d& rkQ, const Triangle2d& tri);
	MESHDOCTOR_API cfloat __stdcall DistancePointToTriangle(const cvector3d& rkQ, const Triangle3d& tri);
	MESHDOCTOR_API cfloat __stdcall DistancePointToSegment(const cvector2d& p0, const cvector2d& segs, const cvector2d& sege);
	MESHDOCTOR_API cfloat __stdcall DistancePointToSegment(const cvector3d& p0, const cvector3d& segs, const cvector3d& sege);
