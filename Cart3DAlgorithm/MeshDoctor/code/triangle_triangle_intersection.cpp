...
namespace Cart3DAlgorithm
{
	namespace 
	{
			...
			cvector2d ptri_a[3], cvector2d ptri_b[3])
		{
			...
			ptri_a[0] = select<3>(tri_a[0], a1, a2);
			ptri_a[1] = select<3>(tri_a[1], a1, a2);
			ptri_a[2] = select<3>(tri_a[2], a1, a2);
			...
			ptri_b[0] = select<3>(tri_b[0], a1, a2);
			ptri_b[1] = select<3>(tri_b[1], a1, a2);
			ptri_b[2] = select<3>(tri_b[2], a1, a2);
		...
		bool touches_edge(const cvector3d tri_a[3], const int nb[3], const cvector3d tri_b[3])
		{
			...
			pline_b[0] = select<3>(tri_b[(i + 1) % 3], a1, a2);
			pline_b[1] = select<3>(tri_b[(i + 2) % 3], a1, a2);
